    ...
    >
      <Card className="relative bg-gradient-to-br from-background/80 to-background/40 backdrop-blur-sm border-0 overflow-hidden">
        ...
        <CardHeader className="relative z-10 flex flex-col items-center justify-center gap-4 pt-8 pb-2">
          ...
          <div className="text-center text-3xl font-extrabold text-primary mt-4">Isiya Dahiru</div>
        </CardHeader>
        <CardContent className="space-y-4 relative z-10">
          <p className="text-muted-foreground leading-relaxed">
            Hi, I&apos;m Isiya Dahiru—a passionate full-stack developer and SaaS enthusiast dedicated to building modern, scalable web applications. With a strong foundation in TypeScript, React, Next.js, Django, Python, and Django RestFramework. I thrive on transforming ideas into beautiful, performant products that delight users and drive business growth.
          </p>
          <p className="text-muted-foreground leading-relaxed">
