    ...
    <main className="max-w-5xl mx-auto pt-20 sm:pt-24 pb-12 px-4">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-sm text-muted-foreground mb-4">Last updated: October 10, 2025.</p>

          <p className="mb-4">
            This Privacy Policy describes how tafiyaudev.vercel.app and Isiya Dahiru
            (collectively &#39;we&#39;, &#39;us&#39;, or &#39;Tafiyau Dev&#39;) collect,
          ...
          <p className="mb-4 text-sm">
            This Policy also applies to tafiyaudev.vercel.app, Isiya Dahiru and any
            other websites, domains, applications, services, products, or
            digital properties owned, operated, or offered by Isiya Dahiru
            (personally) or Tafiyau Dev. For clarity, references to
            &quot;we&quot;, &quot;us&quot; or &quot;our&quot; in this Policy include both
            Isiya Dahiru and Tafiyau Dev where applicable.
          </p>
          ...
          <p className="mb-2 text-sm">We use industry-standard security measures (encryption in transit via HTTPS, access controls, and secure hosting) to protect personal data. We regularly review our security practices but cannot guarantee that unauthorized access, hacking, or data loss will never occur. Report suspected breaches to ishaqtafiyau@gmail.com immediately.</p>

          <h4 id="rights" className="mt-4 font-semibold">Your Rights</h4>
          <p className="mb-2 text-sm">You may have rights under applicable data protection laws including to access, correct, update, or delete your personal data. Subject to verification and applicable exceptions, you may also have rights to restrict or object to processing and to request portability of your data. To exercise your rights, send a request to ishaqtafiyau@gmail.com. We may ask for information to verify your identity before fulfilling requests.</p>
          ...
          <p className="mb-2 text-sm">For privacy requests or questions, contact: <a className="underline text-primary" href="mailto:ishaqtafiyau@gmail.com">ishaqtafiyau@gmail.com</a> (personal), <a className="underline text-primary" href="mailto:ishaqtafiyau@gmail.com">ishaqtafiyau@gmail.com</a> (personal), or <a className="underline text-primary" href="mailto:ishaqtafiyau@gmail.com">ishaqtafiyau@gmail.com</a> (Tafiyau Dev). For legal requests, contact <a className="underline text-primary" href="mailto:ishaqtafiyau@gmail.com">ishaqtafiyau@gmail.com</a>. For privacy-related disputes, please include sufficient information to identify your request and allow us to respond promptly.</p>
