...
export const siteConfig: SiteConfig = {
  siteName: 'Tafiyau Dev',
  domain: 'tafiyaudev.vercel.app',
  author: 'Tafiyau Dev',
  ...
  about:
    ...
    author_img: 'https://avatars.githubusercontent.com/u/120321566?v=4',
    keywords: [
    'Isiya Dahiru',
    'Tafiyau Dev',
  ...
  links: {
    website: 'tafiyaudev.vercel.app',
    github: 'https://github.com/IshaaqDaahir',
    linkedin: '#',
    tips: '#',
    email: 'mailto:ishaqtafiyau@gmail.com',
  },
  social: [
    { label: 'GitHub', url: 'https://github.com/IshaaqDaahir', icon: 'github' },
    { label: 'LinkedIn', url: '#', icon: 'linkedin' },
    { label: 'Website', url: 'tafiyaudev.vercel.app', icon: 'globe' },
  ...
  seo: {
    ...
    canonical: 'tafiyaudev.vercel.app',
    image: '/og.png',
    imageAlt: "Isiya Dahiru - Full Stack Developer",
    locale: 'en-US',
    type: 'website',
